...
//case class MalaLikelihoodEvaluator(data: Seq[Double]) extends DistributionEvaluator[Sample] with GradientEvaluator[Sample] {
//
...
//object MalaPriorEvaluator extends DistributionEvaluator[Sample] with GradientEvaluator[Sample] {
//
...
//        val posteriorEvaluator = ProductEvaluator.withGradient[Sample](MalaPriorEvaluator, MalaLikelihoodEvaluator(data))
//
