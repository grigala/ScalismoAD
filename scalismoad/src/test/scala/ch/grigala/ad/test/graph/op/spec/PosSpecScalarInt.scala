...
import ch.grigala.ad.graph.{Node, Pos, Scalar}
import ch.grigala.ad.rule._
import ch.grigala.ad.test.helper.gen.{ScalarIntNodeGen, ScalarIntValueGen}
import ch.grigala.ad.test.helper.rule.ScalarIntCompareRule
