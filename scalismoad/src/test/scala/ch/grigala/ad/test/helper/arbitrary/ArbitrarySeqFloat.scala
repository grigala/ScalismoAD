package ch.grigala.ad.test.helper.arbitrary

import ch.grigala.ad.graph.{ContainerConst, Node, ScalarConst, Var}
import ch.grigala.ad.test.helper.gen.{SeqFloatNodeGen, SeqFloatValueGen}
import ch.grigala.ad.value.{ContainerValue, NonContainerValue, Value}
